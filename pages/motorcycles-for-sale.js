...
// Example static data
const manufacturers = ["sanili motorcycle", "nanfang motorcyle", "YAMAHA motorcycle", "suzuki motorcycle","Honda","Lifang"];
const models = [" Honda CG125", "Lifan LF125", "Civic", "Suzuki DR", " Yamaha YBR 125"];
...
export default function MootorCyclesForSalePage({ initialCategory = "motorcycles" }) {
  ...
  const { region, city } = router.query;
